...
/**
 * 纯 Swift 实现的 SHA-256（避免引入 CommonCrypto 桥接头）。
 * 仅用于把 NAS 文件路径散列为稳定的缓存文件名。
 */
enum SHA256 {

    static func hexString(of string: String) -> String {
        return hexString(of: Array(string.utf8))
    }

    static func hexString(of bytes: [UInt8]) -> String {
